...
import org.apache.kafka.server.log.internals.{LogConfig, ProducerStateManagerConfig}
...
/**
  ...
  * See [[org.apache.kafka.server.log.internals.LogConfig#TopicConfigSynonyms]] for the mapping.
  * <p>
