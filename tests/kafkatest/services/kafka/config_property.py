...
REMOTE_LOG_METADATA_MANAGER_IMPL_PREFIX = "remote.log.metadata.manager.impl.prefix"
REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG = "rlmm.config."  # configurable prefix
REMOTE_LOG_METADATA_TOPIC_REPLICATION_FACTOR = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.topic.replication.factor"
REMOTE_LOG_METADATA_TOPIC_NUM_PARTITIONS = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.topic.num.partitions"
REMOTE_LOG_METADATA_TOPIC_RETENTION_MS = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.topic.retention.ms"
REMOTE_LOG_METADATA_CONSUME_WAIT_MS = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.consume.wait.ms"
REMOTE_LOG_METADATA_SECONDARY_CONSUMER_SUBSCRIPTION_INTERVAL_MS = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + "remote.log.metadata.secondary.consumer.subscription.interval.ms"
RLMM_COMMON_CLIENT_PREFIX = "remote.log.metadata.common.client."
RLMM_COMMON_CLIENT_PREFIX_CONFIG = REMOTE_LOG_METADATA_MANAGER_PREFIX_CONFIG + RLMM_COMMON_CLIENT_PREFIX
RLMM_COMMON_CLIENT_SASL_MECHANISM = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SASL_MECHANISM
RLMM_COMMON_CLIENT_SASL_KERBEROS_SERVICE_NAME = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SASL_KERBEROS_SERVICE_NAME
RLMM_COMMON_CLIENT_SECURITY_PROTOCOL = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SECURITY_PROTOCOL
RLMM_COMMON_CLIENT_SSL_KEY_PASSWORD = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_KEY_PASSWORD
RLMM_COMMON_CLIENT_SSL_KEYSTORE_LOCATION = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_KEYSTORE_LOCATION
RLMM_COMMON_CLIENT_SSL_KEYSTORE_PASSWORD = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_KEYSTORE_PASSWORD
RLMM_COMMON_CLIENT_SSL_TRUSTSTORE_LOCATION = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_TRUSTSTORE_LOCATION
RLMM_COMMON_CLIENT_SSL_TRUSTSTORE_PASSWORD = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_TRUSTSTORE_PASSWORD
RLMM_COMMON_CLIENT_SSL_ENABLED_PROTOCOLS = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_ENABLED_PROTOCOLS
RLMM_COMMON_CLIENT_SSL_PROTOCOL = RLMM_COMMON_CLIENT_PREFIX_CONFIG + SSL_PROTOCOL

REMOTE_LOG_STORAGE_MANAGER_IMPL_PREFIX = "remote.log.storage.manager.impl.prefix"
REMOTE_LOG_STORAGE_MANAGER_PREFIX_CONFIG = "remote.log.storage."  # configurable prefix
HDFS_BASE_DIR = REMOTE_LOG_STORAGE_MANAGER_PREFIX_CONFIG + "hdfs.base.dir"
HDFS_REMOTE_READ_BYTES = REMOTE_LOG_STORAGE_MANAGER_PREFIX_CONFIG + "hdfs.remote.read.bytes"
HDFS_REMOTE_READ_CACHE_BYTES = REMOTE_LOG_STORAGE_MANAGER_PREFIX_CONFIG + "hdfs.remote.read.cache.bytes"
HDFS_USER = REMOTE_LOG_STORAGE_MANAGER_PREFIX_CONFIG + "hdfs.user"
HDFS_KEYTAB_PATH = REMOTE_LOG_STORAGE_MANAGER_PREFIX_CONFIG + "hdfs.keytab.path"
